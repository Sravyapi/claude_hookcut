...
def serve_local_file(
    ...
    try:
        ShortsService.verify_file_ownership(db, file_key, user_id)
...
def get_short(
    ...
    try:
        short = ShortsService.get_short_for_user(db, short_id, user_id)
...
def download_short(
    ...
    try:
        ShortsService.get_short_for_user(db, short_id, user_id)
