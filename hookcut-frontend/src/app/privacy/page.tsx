    ...
    <>
      ...
      <main className="pt-24 pb-16">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-[#E84A2F]/[0.05] blur-[140px]" />
          <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-[#E84A2F]/[0.04] blur-[120px]" />
        </div>
        ...
        <div className="relative max-w-2xl mx-auto px-6">
          ...
          <div className="mb-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-[#E84A2F] flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-[#E84A2F]/25">
                H
              </div>
            ...
            <p className="text-sm text-white/35">
              ...
              <a
                ...
                className="text-[#E84A2F]/80 hover:text-[#E84A2F] underline transition-colors"
              >
          ...
          {/* Glass card */}
          <div className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-8 space-y-8">
