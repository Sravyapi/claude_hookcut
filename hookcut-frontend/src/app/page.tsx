...
export default function Home() {
  ...
  const handleSelectHooks = useCallback(async (
    hookIds: string[],
  ...
  // Marketing home renders full-width (no padded container)
  if (step === "input") {
    return (
      <>
        <Header onReset={resetAll} />

        {/* Error banner from previous failed analysis */}
        <AnimatePresence>
          {error && (
            <motion.div
        ...
        <main id="main-content">
          <MarketingHome onAnalyze={handleAnalyze} />
        </main>
